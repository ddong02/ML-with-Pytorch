...
def main():
    writer = SummaryWriter('runs/mnist_1')
    ...
    for epoch in range(epochs):
        ...
        print(f'Validation Loss: {avg_val_loss:.4f},  Validation Acc: {val_acc.item():.4f}')
        writer.add_scalar('Loss/validaion', avg_val_loss, epoch+1)
        writer.add_scalar('Accuracy/validation', val_acc.item(), epoch+1)
